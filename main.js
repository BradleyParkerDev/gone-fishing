...
between 1.00 and 5.99 lbs. Then the fish's value is generated by mulitplying the weight by a predetermined
...
function generateFish(){
    let value = 0;
    let weight =  Number((Math.random() * 5)+ 1).toFixed(2)
    
    if(weight < 3){
        value = (weight * 2.2).toFixed(2)
    }
    else if(weight >= 3){
        value = (weight * 3.3).toFixed(2)
    }
